...
import com.optum.tops.J5427HC1.concurrency.Imp.CallableClaimTask;
import com.optum.tops.J5427HC1.concurrency.Imp.OneClaimTask;
...
public class RequestProcessor implements IRequestProcessor{
	...
	@Autowired 
	ICheckCOBClaim cobclaimcheck ; //Service that checks if a claim is a COB claim, NYSTATECOB, Penny Process claim
	...
	@Autowired 
	IInstlReduction2140Service instlRed2140; //A Service that utilizes another service RedProcessor for getting DP835RED Data
	...
	/* (non-Javadoc)
	 * @see com.optum.tops.J5427HC1.services.IRequestProcessor#process(com.optum.tops.J5427HC1.models.Hc1Request)
	 */
	@Override
