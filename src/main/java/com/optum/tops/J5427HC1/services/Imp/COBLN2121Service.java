...
import com.optum.tops.J5427HC1.dao.D54DAO.IFetchCoblnAmtsDao;
...
@Service
public class COBLN2121Service implements ICOBLN2121Service {
	@Autowired 
	IFetchCoblnAmtsDao CoblnAmtsDao ;
	Logger logger=Logger.getLogger("genLogger");
	
	/* (non-Javadoc)
	 * @see com.optum.tops.J5427HC1.services.ICOBLN2121Service#getResultsCobln_Line_Flds(com.optum.tops.J5427HC1.models.ReqClaimEntryVO, com.optum.tops.J5427HC1.models.V5427HC1)
	 */
	@Override
		...
		try {
			...
			for(COBLN_LINE_FLDS line: results){
				...
				if(indicatorObject.getPENNY_PROC_INDICATOR().equals("Y")){
					...
					outboundClaim = penny_process_adjustment (line, outboundClaim,individual_claim2.getLogId()); 
	...
	private V5427HC1 penny_process_adjustment(COBLN_LINE_FLDS line , V5427HC1 outboundClaim, String logId){
		String location="J5427HC1.services.COBLN2121Service.penny_process_adjustment(COBLN_LINE_FLDS, V5427HC1, String)";
		try {
