...
//
@Service
public class OpsHcfaService implements IOpsHcfaService {
	
	@Autowired 
	ICheckOPS_HCFADAO OPSHCFA_claim_checker ; 
	
	/* (non-Javadoc)
	 * @see com.optum.tops.J5427HC1.services.IOpsHcfaService#Ops_Hcfa_claim_check(com.optum.tops.J5427HC1.models.ReqClaimEntryVO, com.optum.tops.J5427HC1.models.V5427HC1)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.optum.tops.J5427HC1.services.IOpsHcfaService#get_CSR_ORIGHDR_DATA(com.optum.tops.J5427HC1.models.ReqClaimEntryVO, com.optum.tops.J5427HC1.models.V5427HC1)
	 */
	@Override
