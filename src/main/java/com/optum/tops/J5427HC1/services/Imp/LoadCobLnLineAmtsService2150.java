...
@Service
public class LoadCobLnLineAmtsService2150 implements ILoadCobLnLineAmtsService2150 {
	Logger logger=Logger.getLogger("genLogger");


	/* (non-Javadoc)
	 * @see com.optum.tops.J5427HC1.services.ILoadCobLnLineAmtsService2150#do2150Section(com.optum.tops.J5427HC1.models.V5427HC1, com.optum.tops.J5427HC1.models.ReqClaimEntryVO)
	 */
	@Override
