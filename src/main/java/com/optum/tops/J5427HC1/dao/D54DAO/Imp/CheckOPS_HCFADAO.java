...
import com.optum.tops.J5427HC1.dao.D54DAO.ICheckOPS_HCFADAO;
...
public class CheckOPS_HCFADAO implements ICheckOPS_HCFADAO {
	...
	/* (non-Javadoc)
	 * @see com.optum.tops.J5427HC1.dao.D54DAO.ICheckOPS_HCFADAO#am_i_OPS_HCFA(com.optum.tops.J5427HC1.models.ReqClaimEntryVO, com.optum.tops.J5427HC1.models.V5427HC1)
	 */
	@Override
	public V5427HC1 am_i_OPS_HCFA(ReqClaimEntryVO individual_claim2, V5427HC1 claim) {
		String location="J5427HC1.dao.D54DAO.CheckOPS_HCFADAO.am_i_OPS_HCFA(ReqClaimEntryVO, V5427HC1)";
		Connection con = null;
		...
		try {
			...
			ps.setString(1, individual_claim2.getReqClaimEntry().getHc1_REQ_CLM_INVN_CTL_NBR());
			ps.setString(2, claim.getMy_indicator().getDBKE2_ICN_SUFX_CD());
			ps.setString(3, individual_claim2.getReqClaimEntry().getHc1_REQ_CLM_PROC_DT());
			...
			if(!rs.next()){
				...
				logger.info(location.concat(" OPS_HCFA Claim").concat(" OPS_HCFA_INDICATOR:").concat("[").concat(claim.getMy_indicator().getOPS_HCFA_INDICATOR()).concat("]")
						.concat(" LOGID:").concat("[").concat(individual_claim2.getLogId()).concat("]"));
	...
	/* (non-Javadoc)
	 * @see com.optum.tops.J5427HC1.dao.D54DAO.ICheckOPS_HCFADAO#get_CSR_ORIGHDR(com.optum.tops.J5427HC1.models.ReqClaimEntryVO, com.optum.tops.J5427HC1.models.V5427HC1)
	 */
	@Override
	public V5427HC1 get_CSR_ORIGHDR(ReqClaimEntryVO incoming_claim, V5427HC1 claim) {
		String location="J5427HC1.dao.D54DAO.CheckOPS_HCFADAO.get_CSR_ORIGHDR(ReqClaimEntryVO, V5427HC1)";
		Connection con = null;
		PreparedStatement ps = null;
		...
		try{
			...
			ps.setString(1, incoming_claim.getReqClaimEntry().getHc1_REQ_CLM_INVN_CTL_NBR());
			ps.setString(2, claim.getMy_indicator().getDBKE2_ICN_SUFX_CD());
			ps.setString(3, incoming_claim.getReqClaimEntry().getHc1_REQ_CLM_PROC_DT());
			ps.setString(4, incoming_claim.getReqClaimEntry().getHc1_REQ_CLM_PROC_TM());
			ps.setString(5, claim.getMy_indicator().getDBKE2_ICN_SUFX_VERS_NBR()); 
			...
			if(!rs.next()){
				logger.info(location.concat(" Empty Resultset;No ADJD_CLMSF_ORIGHDR_LINE returned").concat(" LOGID:").concat("[").concat(incoming_claim.getLogId()).concat("]"));
			}
			else{
				do{
