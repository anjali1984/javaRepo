...
import com.optum.tops.J5427HC1.JP835RED.DAO.IJP835REDDao;
import com.optum.tops.J5427HC1.services.*;

public class JP835REDDao implements IJP835REDDao {
	
	@Autowired 
	IRequestProcessor requestProc;
	
	/* (non-Javadoc)
	 * @see com.optum.tops.J5427HC1.JP835RED.DAO.Imp.IJP835REDDao#RedProcess()
	 */
	@Override
