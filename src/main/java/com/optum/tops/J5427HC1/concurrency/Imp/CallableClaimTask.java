...
public class CallableClaimTask implements Callable<V5427HC1>, ICallableClaimTask {
	...
	public CallableClaimTask(ReqClaimEntryVO individual_claim, HC1Response response, int index, ICheckCOBClaim cobclaimcheck,
		...
		this.response_this_thread_will_add_to = response;
	...
	/* (non-Javadoc)
	 * @see com.optum.tops.J5427HC1.concurrency.ICallableClaimTask#call()
	 */
	@Override
	...
	private V5427HC1 processOneClaimTask(ReqClaimEntryVO individual_claim, HC1Response response_this_thread_will_add_to2, int index) {
		// TODO Auto-generated method stub
		...
		if (currentClaim.getHC1_COB_COB_CLAIM_INDICATOR().equals("N")) {
			...
			synchronized(response_this_thread_will_add_to){
				response_this_thread_will_add_to.getResponse_map_all_claims().put(position_of_claim_in_requestlist, currentClaim);
			}
