...
public class V5427HC1 {
	...
	public void setHC1_COB_NEW_COB_CALC_IND(String hC1_COB_COB_CLAIM_IND) {
		HC1_COB_NEW_COB_CALC_IND = hC1_COB_COB_CLAIM_IND;
	}
	...
	public void setHC1_COB_NEW_COB_835_PROC_IND(String hC1_COB_COB_835_PROC_IND) {
		HC1_COB_NEW_COB_835_PROC_IND = hC1_COB_COB_835_PROC_IND;
	}
	...
	public String toString() {
		return "V5427HC1 [HC1_COB_INVENTORY_CONTROL_DT=" + HC1_COB_INVENTORY_CONTROL_DT
				+ ", HC1_COB_COB_CLAIM_INDICATOR=" + HC1_COB_COB_CLAIM_INDICATOR + ", HC1_COB_NEW_COB_835_PROC_IND="
				+ HC1_COB_NEW_COB_835_PROC_IND + ", HC1_COB_INST_OR_PROF=" + HC1_COB_INST_OR_PROF + ", error=" + error
